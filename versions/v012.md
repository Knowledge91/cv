...
### About me
I am Software Engineer by passion. During my 5+ years of experience as a professional developer I led the technological infrastructure of three Startups. Apart from implementing a new YouTube feature I am advising a team of three developers while taking care of their infrastructure (self hosted Kubernetes + CEPH cluster) and PostgreSQL backend.
...
:   **CTO & Co-Founder**, Server Infrastructure, *[Aplikato](https://aplikato.de)* (Startup)
    ...
    - Implemented PostgreSQL database served via a Flask API.
    - Built server and networking infrastructure. Implemented Kubernetes with dynamic Ceph storage provision and Jenkins CI/CD automation.
