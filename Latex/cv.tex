...
\begin{minipage}[t]{0.65\textwidth}
  ...
  \begin{tabularx}{\textwidth}{rX}
    \job{Software Engineer (TVC)}{Google}{present}{}{
      \item Implemented the Video verification frontend based on Wiz hosted on a
      Boq Web UI node
      \item Throughout tested the application using JsUnit, JsWire unit tests
      and WebDriver integration tests.
      \item Responsible for the UX/ UI alignment and implementation.
    }
    \job{Big Data Solution Architect}{Fresenius Medical Care}{January 2020}{March 2020}{
      \item Oversaw the creation of a data lake.
