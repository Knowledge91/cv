...
\begin{minipage}[t]{0.65\textwidth}
  ...
  \begin{tabularx}{\textwidth}{rX}
    \job{Software Engineer}{Google (TVC)}{present}{-}{
      \item Implemented a WebRTC video streaming front end.
      \item Throughout tested the application using unit and integration tests.
      \item Implemented accessibility features.
      \item Implemented the audit recording infrastructure.
      \item Was responsible for the UX/ UI alignment and implementation.
    }
    \job{Big Data Solution Architect}{Fresenius Medical Care}{January 2020}{March 2020}{
      ...
      \item Architectured a scalable storage, query and application layer of
      the Data Lake (Kubernetes, MinIO, Apache Parquet, Presto, Ranger).
